...
| [USER.PROFILE Author Location](./author-profile-location-contract.md) | Changing automatic author-location reads, Web-profile parsing, or floor metadata | Main page/prefetch integration, cache/lifecycle boundaries, request pacing, and session-stop contract |
