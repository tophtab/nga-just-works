...
- Reused `.trellis/tasks/archive/2026-09/09-11-upstream-august-2026-review/research/bugfix-browser.md` and `data-refactor.md`; no repeated upstream audit or searches of other clients for missing App wire semantics.
